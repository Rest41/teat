      ...
      mentions(cptl, x, true)
       ...
       // CMD
        ...
        case 'creator':
               ...
               buttons = [{buttonId: '!sourcecode',buttonText:{displayText: 'Sc Bot'},type:1},{buttonId:'!infoig',buttonText:{displayText:'Info owner'},type:1}]
...
Saya  Bot WhatsApp yang membantu kamu mempermudah sesuatu seperti Membuat Sticker dan Lainnya, ada Butuh Info Dariku\n💌 Contacts Owner 💌\n wa.me/${owner}`
               ...
               buttonsMessage = {
               contentText: `${menu}`,
               footerText: '© Note jika wa mod silahkan ketik /command\nwhatsapp mod tidak Support buttons', imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
...
//------------------< Ingfo Bot >-------------------
      case 'runtime':
       ...
       case 'sc': 
       case 'src':
              textImg(`Bot ini menggunakan sc : https://youtu.be/cbCezuTRwcQ\ncredits Nino =http://wa.me/6285215319934`)
              break
      case 'ping':
      case 'speed':
              timestampe = speed();
